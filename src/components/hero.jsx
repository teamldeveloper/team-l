...
const Hero = () => {
  return (
    <div className=" md:h-96 flex items-center justify-center flex-col ">
      ...
      <h2 className="text-lg text-black/80 md:text-2xl ">
...
export default SectionWrapper(Hero, "home", "bg-gray-200");
